...
#ifndef OPENWSP_AUDIOFORMAT_H_
#define OPENWSP_AUDIOFORMAT_H_
...
static inline int af_fmt2bits(int format) {
...
static inline int af_bits2fmt(int bits) {
    return (bits/8 - 1) << 3;
}

} // namespace openwsp

#endif //!defined(OPENWSP_AUDIOFORMAT_H_)
